  ...
  return (
    <div className="container-main">
      <h1 className="heading-primary">
        Current ERC20 symbol: {tokenInfo.symbol}
      </h1>
      <h2 className="heading-secondary">Current ERC20 name: {tokenInfo.name}</h2>
      {/* <OldSchoolTicker
                items={[CONTRACT_ADDRESS, tokenInfo.symbol, tokenInfo.name]}
            /> */}
      <p className="text-center mb-4">
        To change the token name and symbol in the contract, simply rent the ad
        space for the duration you require!
      </p>
      ...
      <div>
        <Card className="card-primary">
          <CardContent className="card-content text-center">
            ...
            <p className="mb-2">
              <span className="font-semibold">Next slot available:</span>{" "}
              {nextAvailable(adSpaceInfo.daysToWait)}
            </p>
            <p>
              <span className="font-semibold">Base Fee:</span> {adSpaceInfo.fee}{" "}
              ETH
            </p>
          </CardContent>
        </Card>
      ...
      <Card className="card-quaternary mt-8">
        <CardContent className="card-content text-center">
          ...
          <div className="flex space-x-4 mt-4">
            <Button onClick={handleQuote} className="btn-primary flex-1">
              Get Quote
            </Button>
            <Button
          ...
          {quoteAmount && (
            <p className="heading-accent mt-4">
              Quote: {quoteAmount} {payWithTokens ? tokenInfo.symbol : "ETH"}
            </p>
          )}
        </CardContent>
      </Card>
